...
const experiences = [
  {
    ...
    color: '#2563eb',
    points: [
      'Designed user flows, wireframes, and high-fidelity UI screens in Figma, improving task clarity by 30% based on internal review feedback.',
      'Applied usability principles and visual hierarchy best practices, reducing design iteration cycles by 25%.',
      'Collaborated with cross-functional teams to streamline design-to-development handoff, significantly improving efficiency.',
      'Translated business requirements into structured, user-centered interfaces aligned with product goals.',
    ],
  },
  {
    ...
    color: '#ff5c2e',
    points: [
      'Created campaign creatives and visual content layouts, improving visual hierarchy to increase overall engagement by 35%.',
              ...
              >
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.75rem', flexWrap: 'wrap', gap: '0.5rem' }}>
                    <div>
                      <h3 style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, fontSize: '1.2rem', color: '#fff' }}>
                        {exp.role}
                      </h3>
